...
<template>
    <Head :title="`Modifica: ${props.post.title}`" />
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                        Aggiorna i contenuti e le impostazioni del post
                    </p>
                </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                                <div class="space-y-3">
                                    ...
                                    >
                                        ...
                                        {{ form.processing ? 'Aggiornamento...' : 'Aggiorna Post' }}
                                    </button>
                                    
                                    <Link :href="route('admin.posts.show', props.post.id)">
                                        <button type="button" class="w-full inline-flex items-center justify-center px-4 py-3 bg-blue-100 hover:bg-blue-200 text-blue-700 font-semibold rounded-lg transition-colors">
                                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
